...
export const STAGE_CONFIGS: StageConfig[] = [
    ...
    },
    {
        ...
        duration: 180,
        waves: [
            { time: 5, enemyId: 'enemy_mech_bug', count: 20, interval: 0.7 },
            { time: 30, enemyId: 'enemy_fast_bug', count: 12, interval: 0.5 },
            { time: 60, enemyId: 'enemy_mech_bug', count: 30, interval: 0.4 },
            { time: 90, enemyId: 'enemy_fast_bug', count: 20, interval: 0.3 },
        ],
        bossTime: 150,
        bossEnemyId: 'enemy_boss',
        baseHealth: 100,
    ...
    },
    {
        ...
        duration: 180,
        waves: [
            { time: 5, enemyId: 'enemy_mech_bug', count: 25, interval: 0.6 },
            { time: 30, enemyId: 'enemy_fast_bug', count: 20, interval: 0.4 },
            { time: 60, enemyId: 'enemy_heavy_mech', count: 5, interval: 1.5 },
            { time: 90, enemyId: 'enemy_mech_bug', count: 35, interval: 0.3 },
        ],
        bossTime: 150,
        bossEnemyId: 'enemy_boss',
        baseHealth: 100,
