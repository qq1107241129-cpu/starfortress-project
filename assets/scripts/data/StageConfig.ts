...
export const STAGE_CONFIGS: StageConfig[] = [
    {
        ...
        duration: 180,
        waves: [
            { time: 5, enemyId: 'enemy_mech_bug', count: 600, interval: 0.1 },
            { time: 30, enemyId: 'enemy_mech_bug', count: 8, interval: 0.5 },
            { time: 60, enemyId: 'enemy_mech_bug', count: 10, interval: 0.4 },
