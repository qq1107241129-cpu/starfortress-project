...
export const STAGE_CONFIGS: StageConfig[] = [
    {
        ...
        duration: 180,
        waves: [
            { time: 5, enemyId: 'enemy_mech_bug', count: 5, interval: 2 },
            { time: 30, enemyId: 'enemy_mech_bug', count: 8, interval: 1.5 },
            { time: 60, enemyId: 'enemy_mech_bug', count: 10, interval: 1.2 },
            { time: 90, enemyId: 'enemy_fast_bug', count: 3, interval: 1 },
        ],
        bossTime: 150,
