...
export const STAGE_CONFIGS: StageConfig[] = [
    {
        ...
        duration: 180,
        waves: [
            { time: 1, enemyId: 'enemy_mech_bug', count: 60, interval: 0.5 },
            { time: 30, enemyId: 'enemy_mech_bug', count: 120, interval: 0.2 },
            { time: 60, enemyId: 'enemy_mech_bug', count: 180, interval: 0.1 },
            { time: 90, enemyId: 'enemy_fast_bug', count: 240, interval: 0.1 },
        ],
        bossTime: 150,
