...
## 22. 最小可视化战斗 Demo（011.5-battle-visual-demo）

### 22.1 系统概述

在进入平台构建前，需要先补齐一个最小可视化战斗层，让 Web 预览中可以肉眼看到"塔打怪"的基本过程。可视化层只负责显示，不修改战斗逻辑和数值。

### 22.2 可视化范围

- 敌人生成时可以看到敌人节点出现在路径起点
- 敌人可以沿路径移动
- 敌人有血条显示
- 塔攻击时可以看到攻击线特效
- 塔攻击时有闪烁反馈
- 敌人死亡后，对应可视节点消失
- 战斗倒计时、基地血量、结算 UI 仍正常工作

### 22.3 敌人显示

使用简单方块表示敌人，根据类型设置不同颜色：
